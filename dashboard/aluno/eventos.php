...
// Consultar eventos futuros do aluno
$result_eventos = $mysqli->query("SELECT * FROM eventos WHERE data_evento >= CURDATE() AND usuario_id = '$user_id' ORDER BY data_evento ASC");
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="main-content" id="main-content">
            ...
            <div class="container-fluid">
                <h1 class="my-4">Eventos Futuros</h1>
                        ...
                        <?php foreach ($events as $event): ?>
                            <div class="col-md-4">
                                <div class="card card-custom">
                                    <div class="card-body">
                                        <h5 class="card-title"><?php echo htmlspecialchars($event['nome']); ?></h5>
                                        <p class="card-text"><strong>Data:</strong> <?php echo date('d/m/Y', strtotime($event['data_evento'])); ?></p>
                                        <p class="card-text"><strong>Descrição:</strong> <?php echo htmlspecialchars($event['descricao']); ?></p>
                                        <a href="evento_detalhes.php?id=<?php echo $event['id']; ?>" class="btn btn-primary">Ver Detalhes</a>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
                ...
                <?php else: ?>
                    <p>Você não tem eventos futuros.</p>
                <?php endif; ?>
