...
try {
    ...
    // Consultar tarefas vinculadas ao aluno (CONSULTA CORRIGIDA)
    $sql = "SELECT t.* 
            FROM tarefas t
...
<head>
    ...
    /* Sidebar Styles (mantido do original) */
    .sidebar {
        min-height: 100vh;
...
<body>
    <!-- ... (código HTML anterior do sidebar permanece igual) ... -->
                        ...
                        <div class="col">
                            <div class="card card-custom h-100">
                                <div class="card-body">
                                    ...
                                    <div class="card-text" id="descricao-<?php echo $tarefa['id']; ?>">
                                        <?php echo nl2br(htmlspecialchars($tarefa['descricao'])); ?>
                                    </div>
                                    
                                    <?php if (strlen($tarefa['descricao']) > 150): ?>
